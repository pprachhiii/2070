...
// Simplified rectangle coordinates for all your states
const indiaStates = [
  ...
  { id: 'rajasthan', name: 'Rajasthan', x: 250, y: 250, width: 180, height: 150 },
  ...
  { id: 'uttar-pradesh', name: 'Uttar Pradesh', x: 500, y: 250, width: 180, height: 120 }
];
    ...
    <div className="relative w-full h-[700px] bg-gradient-to-br from-slate-900 to-slate-800 rounded-lg overflow-hidden">
      <svg width="100%" height="100%" viewBox="0 0 900 900">
        ...
        {indiaStates.map(state => {
          const info = stateData.find(s => s.id === state.id);
          const ecoScore = info?.ecoScore ?? 50;
        ...
        <g transform="translate(50, 750)">
          ...
          {[
            ...
            <g key={i} transform={`translate(10, ${35 + i * 15})`}>
      ...
      {hoveredStateData && (
        <div
          ...
          style={{ left: tooltipPosition.x + 10, top: tooltipPosition.y - 10, transform: 'translateY(-100%)' }}
        >
